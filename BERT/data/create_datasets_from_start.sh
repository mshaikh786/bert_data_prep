...
if [ "$to_download" = "wiki_books" ] ; then
    echo "python3 $SRC_DIR/data/bertPrep.py --action download --dataset bookscorpus"
    python3 $SRC_DIR/data/bertPrep.py --action download --dataset bookscorpus
fi

echo "python3 $SRC_DIR/data/bertPrep.py --action download --dataset wikicorpus_en"
python3 $SRC_DIR/data/bertPrep.py --action download --dataset wikicorpus_en

echo "python3 $SRC_DIR/data/bertPrep.py --action download --dataset google_pretrained_weights  # Includes vocab"
python3 $SRC_DIR/data/bertPrep.py --action download --dataset google_pretrained_weights  # Includes vocab

echo "python3 $SRC_DIR/data/bertPrep.py --action download --dataset squad"
python3 $SRC_DIR/data/bertPrep.py --action download --dataset squad

echo "python3 $SRC_DIR/data/bertPrep.py --action download --dataset mrpc"
python3 $SRC_DIR/data/bertPrep.py --action download --dataset mrpc

echo "python3 $SRC_DIR/data/bertPrep.py --action download --dataset sst-2"
...
if [ ! -d "${SRC_DIR}/wikiextractor" ] ; then
	echo "Cloning wikiextractor and applying patch"
...
if [ "$to_download" = "wiki_books" ] ; then
    echo "python3 $SRC_DIR/data/bertPrep.py --action text_formatting --dataset bookscorpus"
    python3 $SRC_DIR/data/bertPrep.py --action text_formatting --dataset bookscorpus
fi

echo "python3 $SRC_DIR/data/bertPrep.py --action text_formatting --dataset wikicorpus_en"
...
# Shard the text files
echo "python3 $SRC_DIR/data/bertPrep.py --action sharding --dataset $DATASET"
python3 $SRC_DIR/data/bertPrep.py --action sharding --dataset $DATASET

# Create HDF5 files Phase 1
echo "python3 $SRC_DIR/data/bertPrep.py --action create_hdf5_files --dataset $DATASET --max_seq_length 128 --max_predictions_per_seq 20 --vocab_file $BERT_PREP_WORKING_DIR/download/google_pretrained_weights/uncased_L-24_H-1024_A-16/vocab.txt --do_lower_case 1"
...
echo "python3 $SRC_DIR/data/bertPrep.py --action create_hdf5_files --dataset $DATASET --max_seq_length 512 --max_predictions_per_seq 80 --vocab_file $BERT_PREP_WORKING_DIR/download/google_pretrained_weights/uncased_L-24_H-1024_A-16/vocab.txt --do_lower_case 1"
